# tests/test_friendship_endpoints.py
...
async def test_friendship_crud_flow(client):
    # 1) Register & login two users: Alice and Bob
    ...
    # We assume Alice’s user_id = 1, Bob’s user_id = 2
